...
class UsersSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::newUser("mariam.magdy", "Mariam", "Magdy", User::TYPE_SALES, "mariam.magdy"); //4 -
        ...
        User::newUser("omar.khaled", "Omar", "Khaled", User::TYPE_SALES, "omar.khaled", manager_id: 13); //14
        User::newUser("rana.mohamed", "Rana", "Mohamed", User::TYPE_SALES, "rana.mohamed", manager_id: 13); //15
    }
}
