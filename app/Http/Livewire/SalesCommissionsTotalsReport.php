...
class SalesCommissionsTotalsReport extends Component
{
    use WithPagination;
    ...
    public function clearPaymentDates(): void
    {
        ...
        $this->Epayment_date_from = null;
        $this->Epayment_date_to = null;
    }
    ...
    public function render()
    {
        ...
        return view('livewire.sales-commissions-totals-report', [
            'STATUSES' => $STATUSES,
            'totals' => $totals,
