...
class CommProfileShow extends Component
{
    ...
    // CommProfilePayment delete methods
    public function dismissDeleteCommPayment()
    {
        $this->deleteCommPaymentId = null;
    }

    public function confirmDeleteCommPayment($id)
    {
        $this->deleteCommPaymentId = $id;
    }
    ...
    public function render()
    {
        ...
        $totalPaid = DB::table('comm_profile_payments')
            ...
            ->selectRaw('SUM(IF(partial_paid > 0, partial_paid, amount)) as paid_amount')
            ->first()->paid_amount ?? 0;
