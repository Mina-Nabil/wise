...
@section('content')
    ...
    <div>
        <div class="input-area mb-3">
            <div class="relative">
                <input type="text" class="form-control !pr-12 mr-2" placeholder="Search">
                ...
                <div
                    ...
                    <button class="btn-sm" data-tippy-content="Filter" type="button" id="primaryOutlineDropdownMenuButton"
            ...
            <div class="card mb-5">
                <div class="card-body">
                    <div class="card-text h-full">
                        ...
                        <div class="py-3 px-5">
                            <h5 class="card-subtitle">Motor - مصر للتأمين</h5>
                            ...
                            <p class="card-text mt-3">Lorem ipsum dolor sit amet, consec tetur adipiscing elit, sed do
                                eiusmod
                                tempor incididun ut labore et dolor magna aliqua.</p>
                        </div>
                    </div>
                </div>
            </div>
