...
<body class=" font-inter dashcode-app">
    ...
    <main class="app-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="{{ url('/companies') }}" class="navItem @yield('companies')">
                            <span class="flex items-center">
                                <iconify-icon class="nav-icon" icon="heroicons:building-storefront"></iconify-icon>
                                <span>Companies</span>
                            </span>
                        </a>
                    </li>
      ...
      inline-flex items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <span class="flex-none text-slate-600 dark:text-white text-sm font-normal items-center lg:flex hidden overflow-hidden text-ellipsis whitespace-nowrap">{{ ucwords(Auth::user()->username) }}</span>
