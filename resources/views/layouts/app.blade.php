        ...
        <div class="sidebar-wrapper group">
            ...
            <div class="logo-segment">
                <a class="flex items-center" href="index.html">
                    ...
                    <span
                        class="ltr:ml-3 rtl:mr-3 text-xl font-Inter font-bold text-slate-900 dark:text-white">Wise</span>
                </a>
                <!-- Sidebar Type Button -->
                            ...
                            <div class="main-menu active">
                                <ul>
                                    ...
                                    <li>
                                        <a href="index.html">
                                            <div class="flex space-x-2 items-start rtl:space-x-reverse">
                                                <iconify-icon icon=mingcute:car-line
                                                    class="leading-[1] text-base"> </iconify-icon>
                                                <span class="leading-[1]">
                                                    Cars
                                                </span>
                                    ...
                                    <li>
                                        <a href="index.html">
                                            <div class="flex space-x-2 items-start rtl:space-x-reverse">
                                                <iconify-icon icon=material-symbols:policy-outline-rounded
                                                    class="leading-[1] text-base"> </iconify-icon>
                                                <span class="leading-[1]">
                                                    Policies
                                                </span>
