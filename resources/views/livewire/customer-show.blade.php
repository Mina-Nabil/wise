    ...
    <div class="sm:flex">
        <div class="max-w-screen-lg">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
                ...
                dark:text-slate-300 col-span-3">
                    ...
                    @endif
                    <div class="md:flex-1 rounded-md overlay max-w-[520px] min-w-\[var\(500px\)\] sm:col-span-3"
                        ...
                        <div @class([
                            ...
                            <div class="card-text flex flex-col justify-between  menu-open">
                                ...
                                @if ($customer->addresses->isEmpty())
                                    <p class="text-center m-5 text-primary">No addresses added to this customer. Please
                                        add an address with a city</p>
                                @else
                    ...
                    <div class="md:flex-1 rounded-md overlay  max-w-[400px] min-w-[310px] sm:col-span-3">
                        ...
                        <div @class([
                            ...
                            'ring-1 ring-danger-500' =>
                                ...
                                !$customer->arabic_first_name ||
                                !$customer->arabic_last_name ||
                                !$customer->arabic_middle_name ||
                                !$customer->id_number,
                        ])>
                            <div class="card-text flex flex-col justify-between h-full menu-open ">
                                <p>
                ...
                @if ($section === 'sold_policies')
                    @if ($soldPolicies->isEmpty())
                        <div
                            ...
                            <div class="flex items-start space-x-3 rtl:space-x-reverse">
                                <div class="flex-1">
                                    No sold policies for this customer.
                                </div>
                            </div>
                        </div>
                    @else
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6">
                                    <div class="input-area">
                                        ...
                                        <input id="firstName" type="text" @class([
                                            'form-control',
                                            '!border-danger-500' => $errors->has('firstName') || !$customer->first_name,
                                        ])
                                    ...
                                    <div class="input-area">
                                        ...
                                        <input id="firstName" type="text" @class([
                                            'form-control',
                                            '!border-danger-500' =>
                                                $errors->has('middleName') || !$customer->middle_name,
                                        ])
                                    ...
                                    <div class="input-area">
                                        ...
                                        <input id="firstName" type="text" @class([
                                            'form-control',
                                            '!border-danger-500' => $errors->has('lastName') || !$customer->last_name,
                                        ])
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6">
                                    <div class="input-area">
                                        ...
                                        <input id="firstName" type="text" @class([
                                            'form-control',
                                            '!border-danger-500' =>
                                                $errors->has('ArabicFirstName') || !$customer->arabic_first_name,
                                        ])
                                    ...
                                    <div class="input-area">
                                        ...
                                        <input id="firstName" type="text" @class([
                                            'form-control',
                                            '!border-danger-500' =>
                                                $errors->has('ArabicMiddleName') || !$customer->arabic_middle_name,
                                        ])
                                    ...
                                    <div class="input-area">
                                        ...
                                        <input id="firstName" type="text" @class([
                                            'form-control',
                                            '!border-danger-500' =>
                                                $errors->has('ArabicLastName') || !$customer->arabic_last_name,
                                        ])
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    ...
                                    <div class="input-area">
                                        ...
                                        <input id="lastName" type="text" @class([
                                            'form-control',
                                            '!border-danger-500' => $errors->has('idNumber') || !$customer->id_number,
                                        ])
                                            wire:model="idNumber">
                                    </div>
                                    <div class="input-area">
                            ...
                            <div class="from-group">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mt-3">
                                    ...
                                    <div class="input-area">
                                        ...
                                        <input list="cities" type="text" @class([
                                            'form-control',
                                            '!border-danger-500' =>
                                                $errors->has('EditedCity') || !$customer->address_city,
                                        ])
                                    ...
                                    <div class="input-area">
                                        ...
                                        <input list="countries" type="text" @class([
                                            'form-control',
                                            '!border-danger-500' => $errors->has('EditedCountry'),
                                        ])
