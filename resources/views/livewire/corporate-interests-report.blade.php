<div>
    <div class="flex justify-between flex-wrap items-center">
        <div class="md:mb-6 mb-4 flex space-x-3 rtl:space-x-reverse">
            <h4 class="font-medium lg:text-2xl text-xl capitalize text-slate-900 inline-block ltr:pr-4 rtl:pl-4">
                Client Interests -- Total: {{ $customers->total() }}
            </h4>
        </div>
                ...
                <div class="card">
                    ...
                    <header class="card-header cust-card-header noborder" style="display: block;">
                        <div class="flex gap-2">
                            ...
                            @if ($campaign_id)
                                <button class="btn inline-flex justify-center btn-dark btn-sm">
                                    <span wire:click="toggleCampaign">
                                        {{ $campaign_id ? 'Campaign: ' . $campaignName : '' }}
                                        &nbsp;&nbsp;
                                    </span>
                                    <span wire:click="clearCampaign">
                                        <iconify-icon icon="material-symbols:close" width="1.2em"
                                            height="1.2em"></iconify-icon>
                                    </span>
                                </button>
    ...
    @if ($campaignSection)
                ...
                <div
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                        ...
                        <div
                            ...
                            <button wire:click="toggleCampaign" type="button"
                                class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-slate-600 dark:hover:text-white"
                                data-bs-dismiss="modal">
                                <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
        ...
        11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd">
                        ...
                        <div class="p-6 space-y-4">
                            <div class="from-group">
                                <label for="Ecampaign_id" class="form-label">Campaign</label>
                                <select name="Ecampaign_id" id="Ecampaign_id" class="form-control w-full mt-2"
                                    wire:model.defer="Ecampaign_id">
                                    <option class="py-1 inline-block font-Inter font-normal text-sm text-slate-600"
                                        value="">
                        ...
                        <div
                            class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                            <button wire:click="setCampaign" data-bs-dismiss="modal"
                                class="btn inline-flex justify-center text-white bg-black-500">
                                <span wire:loading.remove wire:target="setCampaign">Submit</span>
                                <iconify-icon class="text-xl spin-slow ltr:mr-2 rtl:ml-2 relative top-[1px]"
                                    wire:loading wire:target="setCampaign"
                                    icon="line-md:loading-twotone-loop"></iconify-icon>
