                        ...
                        <tbody
                            ...
                            @foreach ($payments as $payment)
                                <tr class="hover:bg-slate-200 dark:hover:bg-slate-700"
                                    ...
                                    <td>
                                        {{ \Carbon\Carbon::now()->diffInDays(\Carbon\Carbon::parse($payment->policy_payment_due)->addDays($payment->due_penalty), false)    }} Days
                                    </td>

                                    <td>
                                        {{($payment->penalty_percent / 100) * {{ $payment->calculation_type == '%' ? (($payment->value / 100) * $payment->net_premuim) : $payment->value }} }}
                                    </td>
