                                    ...
                                    @if (in_array($entry->id, $showChildAccounts))
                                        @foreach ($entry->accounts as $childAccount)
                                            <tr class="bg-slate-50 dark:bg-slate-700">
                                                ...
                                                <td class="table-td hover:bg-slate-600 " colspan="3" ><b class="hover:underline"  wire:click="redirectToAccount({{ $childAccount->id}})" >{{ $childAccount->main_account->name }} • {{ $childAccount->name }}</b></td>
