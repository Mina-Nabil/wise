            ...
            <div class="flex sm:space-x-4 space-x-2 sm:justify-end items-center md:mb-6 mb-4 rtl:space-x-reverse">
                <div class="dropdown relative ">
                    ...
                    <ul
                        ...
                        <li wire:click="toggleIsCancelled">
                            <span
                            ...
                            <header class="card-header cust-card-header noborder justify-start gap-2">
                                ...
                                @if ($isCancelledFilter !== null)
                                    <button class="btn inline-flex justify-center btn-dark btn-sm">
                                        <span wire:click="toggleIsCancelled">Is Cancelled: {{ $isCancelledFilter ? 'Yes' : 'No' }}</span>
                                        <span wire:click.stop="clearIsCancelled" class="ltr:ml-2 rtl:mr-2">
