    ...
    <div class="flex">
        <div class="max-w-screen-lg">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                ...
                {{-- Name section --}}
                <div>
                    <b>{{ $corporate->name }} </b><iconify-icon class="ml-3" style="position: absolute" wire:loading
                        ...
                        <div class="card-body flex flex-col justify-center bg-cover card p-4">
                            <div class="card-text flex flex-col justify-between  menu-open">
                                ...
                                @if ($corporate->phones->isEmpty())
                                    <p class="text-center m-5 text-primary">No Phones to this corporate.</p>
                                @else
                        ...
                        <div
                            ...
                            <div class="card-text flex flex-col justify-between h-full menu-open">
                                ...
                                @if ($corporate->contacts->isEmpty())
                                    <p class="text-center m-5 text-primary">No bank accounts added to this corporate.
                                    </p>
                                @else
                                    @foreach ($corporate->contacts as $contact)
                                        <p><b> {{ $contact->name }}</b>
                                            <button wire:click="deleteThisContact({{ $contact->id }})"
                                                class="action-btn float-right" type="button">
                                                <iconify-icon icon="heroicons:trash"></iconify-icon>
                                            </button>
                                            <button wire:click="editThisContact({{ $contact->id }})"
                                ...
                                <button wire:click="toggleAddContact"
                                    class="btn inline-flex justify-center btn-light rounded-[25px] btn-sm float-right">Add
                                    Contact</button>
                            ...
                            <div class="card-text flex flex-col justify-between  menu-open">
                                ...
                                @else
                                    @foreach ($corporate->addresses as $address)
                                        ...
                                        <p>Flat: {{ $address->flat ?? 'N/A' }}, Building:
                                            {{ $address->building ?? 'N/A' }}</p>
                                        <p>{{ $address->area ?? 'N/A' }}, {{ $address->city ?? 'N/A' }},
                                            {{ $address->country ?? 'N/A' }}</p>
                                        <br>
                                    @endforeach
                                @endif
                            ...
                            <div class="card-text flex flex-col justify-between h-full menu-open">
                                <p>
                                    ...
                                    <span class="float-right cursor-pointer text-slate-500"
                                        wire:click="toggleEditCorporate">
                                ...
                                <p>{{ $corporate->commercial_record ?? 'N/A' }}
                                    @if ($corporate->commercial_record_doc)
                                        <span
                                            wire:click="downloadDoc('{{ $corporate->commercial_record_doc }}' , 'commercial_record')"
                                            class="text-primary-500 cursor-pointer">download document</span>
                                    @endif
                                </p>
                                <br>
                                ...
                                <p>{{ $corporate->tax_id ?? 'N/A' }}
                                    @if ($corporate->tax_id_doc)
                                        <span wire:click="downloadDoc('{{ $corporate->tax_id_doc }}' , 'tax_id_doc')"
                                            class="text-primary-500 cursor-pointer">download document</span>
                                    @endif
                                </p>
                                <br>
                                ...
                                <p>{{ $corporate->kyc ?? 'N/A' }}
                                    @if ($corporate->kyc_doc)
                                        <span wire:click="downloadDoc('{{ $corporate->kyc_doc }}' , 'kyc_doc')"
                                            class="text-primary-500 cursor-pointer">download document</span>
                                    @endif
                                </p>
                                <br>
                                ...
                                <p>
                                    @if ($corporate->contract_doc)
                                        <span
                                            wire:click="downloadDoc('{{ $corporate->contract_doc }}' , 'contract_doc')"
                                            class="text-primary-500 cursor-pointer">download document</span>
                                    @endif
                                </p>
                                <br>
                                ...
                                <p>
                                    @if ($corporate->main_bank_evidence)
                                        <span
                                            wire:click="downloadDoc('{{ $corporate->main_bank_evidence }}' , 'main_bank_evidence')"
                                            class="text-primary-500 cursor-pointer">download document</span>
                                    @endif
                                </p>
                                <br>
                        ...
                        <div
                            ...
                            <div class="card-text flex flex-col justify-between h-full menu-open">
                                ...
                                @foreach ($LINES_OF_BUSINESS as $lob)
                                    @php
                                        $corporateHasInterest = false;
                                        $interestStatus = 'N/A';
                                        $interestNote = '';
                                        $timestamp = null;
                                    @endphp
                                    @foreach ($corporate->interests as $interest)
                                        @if ($interest->business === $lob)
                                            @php
                                                $corporateHasInterest = true;
                        ...
                        <div
                            ...
                            <div class="card-text flex flex-col justify-between h-full menu-open">
                                ...
                                @if ($corporate->bank_accounts->isEmpty())
                                    <p class="text-center m-5 text-primary">No bank accounts added to this
                                        corporate.</p>
                                @else
                                ...
                                <div class="flex items-center ">
                                    <div>
                                        ...
                                        @if ($followup->line_of_business)
                                            <p>{{ ucwords(str_replace('_', ' ', $followup->line_of_business)) }}
                                            </p>
                                        @endif
                                    </div>
                                        ...
                                        <li class="p-2">
                                            <div
                                                ...
                                                <div class="flex items-start space-x-3 rtl:space-x-reverse">
                                                    <div class="flex-1">
                                                        No tasks related to this corporate!
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
            ...
            <div
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                    ...
                    <div
                        ...
                        <button wire:click="closeDeleteAddress" type="button"
            ...
            <div
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                    ...
                    <div
                        ...
                        <button wire:click="closeDeletePhone" type="button"
                            class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center
                                            dark:hover:bg-slate-600 dark:hover:text-white"
                            data-bs-dismiss="modal">
                            <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20"
            ...
            <div
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                    ...
                    <div
                        ...
                        <button wire:click="closeDeleteContact" type="button"
                            class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center
                                            dark:hover:bg-slate-600 dark:hover:text-white"
                            data-bs-dismiss="modal">
                            <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20"
                    ...
                    <div
                        class="flex items-center p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                        <button wire:click="deleteContact" data-bs-dismiss="modal"
                            class="btn inline-flex justify-center text-white bg-danger-500">Yes, Delete</button>
                    </div>
                </div>
            </div>
                        ...
                        <div class="from-group">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mt-3">
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="lastName" type="text"
                                        class="form-control @error('evidenceDoc') !border-danger-500 @enderror"
                                        wire:model="evidenceDoc">
                                </div>
    ...
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto show"
        ...
        <div class="modal-dialog top-1/2 !-translate-y-1/2 relative w-auto pointer-events-none">
            <div
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                    ...
                    <div
                        ...
                        <button wire:click="closeEditContact" type="button"
                            class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-slate-600 dark:hover:text-white"
                            data-bs-dismiss="modal">
                            <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="from-group">
                            ...
                            <div class="input-area mt-3">
                                ...
                                <input id="lastName" type="text"
                                    class="form-control @error('jobTitle') !border-danger-500 @enderror"
                                    wire:model="jobTitle">
                            </div>
                            @error('jobTitle')
                                <span
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mt-3">
                                <div class="input-area">
                                    ...
                                    <input id="lastName" type="text"
                                        class="form-control @error('contactEmail') !border-danger-500 @enderror"
                    ...
                    <div
                        class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                        <button wire:click="editContact" data-bs-dismiss="modal"
                            class="btn inline-flex justify-center text-white bg-black-500">
                            Submit
                        </button>
                    </div>
            ...
            <div
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                    ...
                    <div
                        ...
                        <button wire:click="toggleAddContact" type="button"
                            class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-slate-600 dark:hover:text-white"
                            data-bs-dismiss="modal">
                            <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto show"
        ...
        <div class="modal-dialog top-1/2 !-translate-y-1/2 relative w-auto pointer-events-none">
            <div
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                    ...
                    <div
                        ...
                        <button wire:click="toggleEditCorporate" type="button"
                            class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-slate-600 dark:hover:text-white"
                            data-bs-dismiss="modal">
                            <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd">
                        ...
                        <div class="from-group">
                                        ...
                                        <span class="block min-w-[140px] text-left">
                                            <span class="inline-block text-center text-sm mx-auto py-1">
                                                <span class="flex items-center space-x-3 rtl:space-x-reverse">
                                                    ...
                                                    <span>
                                                        Document added
                                                        <span wire:click="clearCommercialRecordDoc"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mt-3">
                                ...
                                <div class="input-area">
                                    ...
                                    @if (!$kycDoc)
                                        <input wire:model.defer="kycDoc" type="file"
                                            class="form-control w-full " name="basic" />
                                    @else
                                        <span class="block min-w-[140px] text-left">
                                            <span class="inline-block text-center text-sm mx-auto py-1">
                            ...
                            <div class="input-area mt-3">
                                ...
                                @if (!$contractDoc)
                                    <input wire:model="contractDoc" type="file"
                                        class="form-control w-full " name="basic" />
                                @else
                                    <span class="block min-w-[140px] text-left">
                                        <span class="inline-block text-center text-sm mx-auto py-1">
                                            <span class="flex items-center space-x-3 rtl:space-x-reverse">
                                                ...
                                                <span>
                                                    Document added
                                                    <span wire:click="clearContractDoc"
                                                        class="text-xs text-slate-500 dark:text-slate-400 mt-1 cursor-pointer">|
                                                        remove</span>
                                                </span>
                                            </span>
                            ...
                            <div class="input-area mt-3">
                                ...
                                @if (!$mainBandEvidence)
                                    <input wire:model.defer="mainBandEvidence" type="file"
                                        class="form-control w-full " name="basic" />
                                @else
                                    <span class="block min-w-[140px] text-left">
                                        <span class="inline-block text-center text-sm mx-auto py-1">
                                            <span class="flex items-center space-x-3 rtl:space-x-reverse">
                                                ...
                                                <span>
                                                    Document added
                                                    <span wire:click="clearMainBandEvidence"
                                                        class="text-xs text-slate-500 dark:text-slate-400 mt-1 cursor-pointer">|
                                                        remove</span>
                                                </span>
                                            </span>
                    ...
                    <div
                        class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                        <button wire:click="editCorporate" data-bs-dismiss="modal"
                            class="btn inline-flex justify-center text-white bg-black-500">
                            Submit
                        </button>
                    </div>
