                        ...
                        <div class="card p-5">
                            <div class="card-body rounded-md bg-white dark:bg-slate-800">
                                <div class="items-center text-center p-5">
                                    ...
                                    <h2 class="card-title text-slate-900 dark:text-white mb-3">No Claims with the
                                        applied
                                        filters</h2>
                                    <p class="card-text">Try changing the filters or search terms for this view.
                                    </p>
                                    <a href="{{ url('/claims') }}" class="btn inline-flex justify-center mx-2 mt-3 btn-primary active btn-sm">View
                                        all Claims</a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div wire:ignore>
                                            ...
                                            <select name="basicSelect" id="basicSelect" class="form-control w-full mt-2 @error('assignedTo') !border-danger-500 @enderror" wire:model.defer="assignedTo">
                                                ...
                                                @foreach ($user_types as $type)
                                                    <option value="{{ $type }}" {{ $assignedTo == $type ? 'selected' : '' }}>
                                                        {{ $type }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="input-area">
                                    <div class="filegroup">
                                        <label>
                                            ...
                                            <input type="file" class="w-full hidden " name="basic" multiple="multiple" wire:model.defer="files" />
                            ...
                            <div class="card-text h-full space-y-6 mt-5">
                                <div class="input-area">
                                    <div class="filegroup">
                                        ...
                                        @else
                                            <button wire:click="toggleAddWatchers" class="btn inline-flex justify-center btn-light rounded-[25px] btn-sm">Add
                                                Watchers</button>
                                        @endif
                                    </div>
                                </div>
