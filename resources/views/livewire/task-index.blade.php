<div>
    ...
    <div class="flex mb-">
        ...
        <input class="form-control py-2 flatpickr flatpickr-input active w-auto" style="width:auto" id="range-picker" data-mode="range" value="" type="text" readonly="readonly" wire:model="dateRange">
                        ...
                        <thead class=" border-t border-slate-100 dark:border-slate-800 bg-slate-200 dark:bg-slate-700">
                            <tr>
                                ...
                                <th scope="col" class="table-th">
                                    <span data-tippy-content="Sort by brand" class="scale cursor-pointer">Date</span>
                                </th>

                                <th scope="col" class="table-th">
                                    <span data-tippy-content="Sort by brand" class="scale cursor-pointer">Assigned to</span>
                                </th>

                                <th scope="col" class=" table-th ">
                                    <span data-tippy-content="Sort by Model" class="scale cursor-pointer">Title</span>
                                </th>

                                <th scope="col" class=" table-th ">
                                    <span data-tippy-content="Sort by Category" class="scale cursor-pointer">Type</span>
                                </th>
