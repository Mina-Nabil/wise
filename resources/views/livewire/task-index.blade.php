<div>
    ...
    <div class="flex mb-2">
        ...
        <input class="form-control py-2 w-auto ml-5" style="width:300px" value="" type="text" wire:model="searchText" wire:change="resetPagination()" placeholder="Search by title">
