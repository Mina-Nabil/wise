<div>
    ...
    <div class="flex mb-2">
        ...
        <input class="form-control py-2 flatpickr flatpickr-input active w-auto ml-5" style="width:auto"
                        ...
                        <div class="px-4 pt-4 pb-3">
                            <div class="from-group mb-3">
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                                    <div class="input-area">
                                        ...
                                        <input type="text" class="form-control" value="Bill"
                                            placeholder="Title" wire:model="taskTitle">
                                    </div>
                                    <div class="input-area">
                                        <div wire:ignore>
                                            ...
                                            <select name="basicSelect" id="basicSelect"
                                                class="form-control w-full mt-2" wire:model="assignedTo">
                            ...
                            <div class="input-area mb-3">
                                ...
                                <input class="form-control py-2 flatpickr flatpickr-input active"
                                    id="time-date-picker" data-enable-time="true" value="" type="text"
                                    wire:model="due">
                            </div>
