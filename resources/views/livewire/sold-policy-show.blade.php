<div>
    <div class="bg-no-repeat bg-cover mb-5 p-5 rounded-[6px] relative  flex justify-between" style="background-color: black; padding: 30px;padding-bottom: 5px;">
        <div class="max-w-xl">
            ...
            <div class="dropdown relative">
                ...
                <ul class=" dropdown-menu min-w-max absolute text-sm text-slate-700 dark:text-white hidden bg-white dark:bg-slate-700 shadow
                    ...
                    @if (!$soldPolicy->client_payment_date)
                        <li>
                            <a wire:click="openPaymentDateSec" class="text-slate-600 dark:text-white block font-Inter font-normal px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600
                                dark:hover:text-white cursor-pointer">
                    ...
                    @else
                        <li>
                            <a wire:click="openSetPaidSec" class="text-slate-600 dark:text-white block font-Inter font-normal px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600
                                dark:hover:text-white cursor-pointer">
                                Set as Paid</a>
                        </li>
                    @endif
                    ...
                    <li>
                        <a wire:click="toggleDeleteSoldPolicy" class="text-slate-600 dark:text-white block font-Inter font-normal px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600
                                dark:hover:text-white cursor-pointer">
                        ...
                        <div class="card-body flex flex-col p-6 active justify-center">
                            <div>
                                <span class="text-xs text-slate-500 dark:text-slate-400 block mb-1">
                                    Client payment Date
                                    <span class="float-right">
                                        <iconify-icon wire:click="openPaymentDateSec" class="cursor-pointer" icon="carbon:edit"></iconify-icon>
                                    </span>
                                </span>
                                <span class="text-lg font-medium text-slate-900 dark:text-white block">
                        ...
                        <div class="flex space-x-3 rtl:space-x-reverse">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="text-slate-900 dark:text-white text-lg font-medium flex justify-between">
                                    <span>
                                        {{ $soldPolicy->total_policy_comm ? number_format($soldPolicy->total_policy_comm, 0, '.', ',') : '-' }} EGP
                                    </span>
                                    <button class="action-btn btn-sm" type="button" wire:click="openEditTotalPolCommSection">
                                        <iconify-icon icon="heroicons:pencil-square"></iconify-icon>
                                    </button>
                        ...
                        <div class="flex space-x-3 rtl:space-x-reverse">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="text-slate-900 dark:text-white text-lg font-medium">
                                    {{ $soldPolicy->total_client_paid ? number_format($soldPolicy->total_client_paid, 0, '.', ',') : '-' }} EGP
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body pt-4 pb-3 px-4">
                        <div class="flex space-x-3 rtl:space-x-reverse">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="text-slate-900 dark:text-white text-lg font-medium">
                                    {{ $soldPolicy->total_sales_comm ? number_format($soldPolicy->total_sales_comm, 0, '.', ',') : '-' }} EGP
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body pt-4 pb-3 px-4">
                        <div class="flex space-x-3 rtl:space-x-reverse">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="text-slate-900 dark:text-white text-lg font-medium">
                                    {{ $soldPolicy->total_comp_paid ? number_format($soldPolicy->total_comp_paid, 0, '.', ',') : '-' }} EGP
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            @foreach ($soldPolicy->company_comm_payments as $payment)
                                                <tr>
                                                    ...
                                                    <td class="table-td px-0">
                                                        ...
                                                        @if ($payment->doc_url)
                                                            <iconify-icon class=" cursor-pointer" wire:loading.remove wire:target="downloadCompPaymentDoc({{ $payment->id }})" wire:click="downloadCompPaymentDoc({{ $payment->id }})" icon="pepicons-pop:file" width="1.2em" height="1.2em"></iconify-icon>
                                                            <iconify-icon class="text-xl spin-slow ltr:mr-2 rtl:ml-2 relative top-[1px]" wire:loading wire:target="downloadCompPaymentDoc({{ $payment->id }})" icon="line-md:loading-twotone-loop"></iconify-icon>
                                                        @endif
                                                        @if ($payment->note)
                                                            <iconify-icon class=" cursor-pointer" wire:click="showCompPaymentNote({{ $payment->id }})" icon="gravity-ui:comment" width="1.2em" height="1.2em"></iconify-icon>
                                                        @endif
                                                    </td>
                                                        ...
                                                        <td class="table-td ">
                                                            <div class="dropstart relative">
                                                                ...
                                                                <ul class="dropdown-menu min-w-max absolute text-sm text-slate-700 dark:text-white hidden bg-white dark:bg-slate-700 shadow z-[2] float-left overflow-hidden list-none text-left rounded-lg mt-1 m-0 bg-clip-padding border-none">
                                                                    ...
                                                                    @if ($payment->doc_url)
                                                                        <li>
                                                                            <a wire:click="ConfirmRemoveCompPaymentDoc({{ $payment->id }})" class="hover:bg-slate-900 dark:hover:bg-slate-600 dark:hover:bg-opacity-70 hover:text-white w-full border-b border-b-gray-500 border-opacity-10 px-4 py-2 text-sm dark:text-slate-300  last:mb-0 cursor-pointer first:rounded-t last:rounded-b flex space-x-2 items-center capitalize  rtl:space-x-reverse">
                                                                    ...
                                                                    @else
                                                                        <li>
                                                                            <label for="compPaymentDoc" wire:click="setCompPaymentDoc({{ $payment->id }})" class="hover:bg-slate-900 dark:hover:bg-slate-600 dark:hover:bg-opacity-70 hover:text-white w-full border-b border-b-gray-500 border-opacity-10 px-4 py-2 text-sm dark:text-slate-300  last:mb-0 cursor-pointer first:rounded-t last:rounded-b flex space-x-2 items-center capitalize  rtl:space-x-reverse">
                                                                                <iconify-icon icon="pepicons-pop:file"></iconify-icon>
                                                                                <span>Add document</span></label>
                                                                            <input type="file" id="compPaymentDoc" name="compPaymentDoc" style="display: none;" wire:model="compPaymentDoc">
                                                                        </li>
                                                                    @endif
                                                                </ul>
                                                            </div>
                                                            ...
                                                            <div class="dropstart relative">
                                                                ...
                                                                <ul class="dropdown-menu min-w-max absolute text-sm text-slate-700 dark:text-white hidden bg-white dark:bg-slate-700 shadow z-[2] float-left overflow-hidden list-none text-left rounded-lg mt-1 m-0 bg-clip-padding border-none">
                                                                    @if ($payment->is_new || is_Null($payment->status))
                                                                        ...
                                                                        <li>
                                                                            <a wire:click="openSetPaymentCollectedSec({{ $payment->id }})" class="hover:bg-slate-900 dark:hover:bg-slate-600 dark:hover:bg-opacity-70 hover:text-white w-full border-b border-b-gray-500 border-opacity-10 px-4 py-2 text-sm dark:text-slate-300  last:mb-0 cursor-pointer first:rounded-t last:rounded-b flex space-x-2 items-center capitalize  rtl:space-x-reverse">
                    ...
                    11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                        ...
                        <div class="p-6 space-y-4">
                            <div class="from-group">
                                ...
                                <input name="client_payment_date" type="date" class="form-control mt-2 w-full @error('client_payment_date') !border-danger-500 @enderror" wire:model.defer="client_payment_date">
                        ...
                        <!-- Modal footer -->
                        <div class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                            <button wire:click="setPaid" data-bs-dismiss="modal" class="btn inline-flex justify-center text-white bg-black-500">
                                <span wire:loading.remove wire:target="setPaid">Submit</span>
                                <iconify-icon class="text-xl spin-slow ltr:mr-2 rtl:ml-2 relative top-[1px]" wire:loading wire:target="setPaid" icon="line-md:loading-twotone-loop"></iconify-icon>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                        ...
                        <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-slate-600 bg-black-500">
                            ...
                            <button wire:click="closePaymentDateSec" type="button" class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-slate-600 dark:hover:text-white" data-bs-dismiss="modal">
                                <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10
                    11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                </svg>
                        ...
                        <div class="p-6 space-y-4">
                            <div class="from-group">
                                ...
                                <input name="clientPaymentDate" type="date" class="form-control mt-2 w-full @error('clientPaymentDate') !border-danger-500 @enderror" wire:model.defer="clientPaymentDate">
                        ...
                        <!-- Modal footer -->
                        <div class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                            <button wire:click="changePaymentDate" data-bs-dismiss="modal" class="btn inline-flex justify-center text-white bg-black-500">
                                <span wire:loading.remove wire:target="changePaymentDate">Submit</span>
                                <iconify-icon class="text-xl spin-slow ltr:mr-2 rtl:ml-2 relative top-[1px]" wire:loading wire:target="changePaymentDate" icon="line-md:loading-twotone-loop"></iconify-icon>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                        ...
                        <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-slate-600 bg-black-500">
                            ...
                            <button wire:click="hideCompPaymentComment" type="button" class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-slate-600 dark:hover:text-white" data-bs-dismiss="modal">
                                <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10
                    11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                </svg>
                ...
                <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                        ...
                        <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-slate-600 bg-danger-500">
                            ...
                            <button wire:click="toggleDeleteSoldPolicy" type="button" class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center
                        ...
                        <div class="flex items-center p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                            <button wire:click="deleteSoldPolicy" data-bs-dismiss="modal" class="btn inline-flex justify-center text-white bg-danger-500">Yes,
                                Delete</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                        ...
                        <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-slate-600 bg-danger-500">
                            ...
                            <button wire:click="DissRemoveCompPaymentDoc" type="button" class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center
                                            dark:hover:bg-slate-600 dark:hover:text-white" data-bs-dismiss="modal">
                                <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10
                                                    11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                        ...
                        <!-- Modal footer -->
                        <div class="flex items-center p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                            <button wire:click="removeCompPaymentDoc" data-bs-dismiss="modal" class="btn inline-flex justify-center text-white bg-danger-500">Yes,
                                Remove</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                        ...
                        <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-slate-600 bg-black-500">
                            ...
                            <button wire:click="closeEditTotalPolCommSection" type="button" class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-slate-600 dark:hover:text-white" data-bs-dismiss="modal">
                                <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10
                    11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                </svg>
                        ...
                        <div class="p-6 space-y-4">
                            <div class="from-group">
                                ...
                                <input name="updateTotalPolComm" type="number" class="form-control mt-2 w-full @error('updateTotalPolComm') !border-danger-500 @enderror" wire:model.defer="updateTotalPolComm">
                        ...
                        <!-- Modal footer -->
                        <div class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                            <button wire:click="updateTotalPolComm" data-bs-dismiss="modal" class="btn inline-flex justify-center text-white bg-black-500">
                                <span wire:loading.remove wire:target="updateTotalPolComm">Submit</span>
                                <iconify-icon class="text-xl spin-slow ltr:mr-2 rtl:ml-2 relative top-[1px]" wire:loading wire:target="updateTotalPolComm" icon="line-md:loading-twotone-loop"></iconify-icon>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                    ...
                    <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-slate-600 bg-black-500">
                        ...
                        <button wire:click="closeSetPaymentCollectedSec" type="button" class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-slate-600 dark:hover:text-white" data-bs-dismiss="modal">
                            <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10
                11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                            </svg>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <input type="file" style="display: none" name="uploadCollectedDoc" id="uploadCollectedDoc" wire:model="paymentCollectedDoc">
                        <hr />

                        <div class="from-group">
                            <label class="form-label">Note</label>
                            <textarea class="form-control mt-2 w-full @error('payment_collected_note') !border-danger-500 @enderror" wire:model.defer="payment_collected_note"></textarea>
                    ...
                    <!-- Modal footer -->
                    <div class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                        <button wire:click="setPaymentCollected" data-bs-dismiss="modal" class="btn inline-flex justify-center text-white bg-black-500">
                            <span wire:loading.remove wire:target="setPaymentCollected">Submit</span>
                            <iconify-icon class="text-xl spin-slow ltr:mr-2 rtl:ml-2 relative top-[1px]" wire:loading wire:target="setPaymentCollected" icon="line-md:loading-twotone-loop"></iconify-icon>
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                        ...
                        <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-slate-600 bg-black-500">
                            ...
                            <button wire:click="toggleAddCompanyPayment" type="button" class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-slate-600 dark:hover:text-white" data-bs-dismiss="modal">
                                <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10
                    11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                </svg>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="from-group">
                                ...
                                <select name="compPaymentType" id="basicSelect" class="form-control w-full mt-2 @error('compPaymentType') !border-danger-500 @enderror" wire:model="compPaymentType">
                                    <option class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">
                                        Select type</option>
                                    @foreach ($PYMT_TYPES as $paymentType)
                                        <option value="{{ $paymentType }}" class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">
                            ...
                            <div class="from-group">
                                ...
                                <input type="number" name="compPaymentAmount" class="form-control mt-2 w-full @error('compPaymentAmount') !border-danger-500 @enderror" wire:model.defer="compPaymentAmount">
                            ...
                            <div class="from-group">
                                ...
                                <textarea name="compPaymentNote" class="form-control mt-2 w-full @error('compPaymentNote') !border-danger-500 @enderror" wire:model.defer="compPaymentNote"></textarea>
                        ...
                        <!-- Modal footer -->
                        <div class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                            <button wire:click="addCompanyPayment" data-bs-dismiss="modal" class="btn inline-flex justify-center text-white bg-black-500">
                                <span wire:loading.remove wire:target="addCompanyPayment">Submit</span>
                                <iconify-icon class="text-xl spin-slow ltr:mr-2 rtl:ml-2 relative top-[1px]" wire:loading wire:target="addCompanyPayment" icon="line-md:loading-twotone-loop"></iconify-icon>
                            </button>
                        </div>
                    </div>
                </div>
