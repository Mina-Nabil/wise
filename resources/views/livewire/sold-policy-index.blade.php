                                ...
                                <button class="btn inline-flex justify-center btn-dark btn-sm">
                                    ...
                                    <span wire:click="openCreatorSection">
                                            @foreach ($FilteredCreators as $index => $creator)
                                                {{ $creator->full_name }}@if (!$loop->last), @endif
                                            @endforeach
                                        &nbsp;&nbsp;
                                    </span>
                                    <span wire:click="clearCreator">
                                        <iconify-icon icon="material-symbols:close" width="1.2em" height="1.2em" wire:loading.remove wire:target="clearCreator"></iconify-icon>
                                        <iconify-icon class="text-xl spin-slow" icon="line-md:loading-twotone-loop" wire:loading wire:target="clearCreator"></iconify-icon>
                                    </span>
                                </button>
                            @endif
                        </header>
