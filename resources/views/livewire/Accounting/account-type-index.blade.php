                ...
                <div class="tab-content">
                    <div class="card">
                        <div class="card-body px-6 rounded overflow-hidden pb-3">
                                    ...
                                    <div class="overflow-hidden ">
                                        <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700 ">
                                            ...
                                            <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                                @foreach ($accountsTypes as $type)
                                                    <tr class="even:bg-slate-50 dark:even:bg-slate-700">
                                                        <td class="table-td">
                                                            <span class="block date-text">{{ $type->name }}</span>
                                                        </td>
                                                        <td class="table-td">
                                                            <span class="block date-text">{{ $type->desc }}</span>
                                                        </td>
                                                        <td class="table-td">
                                                            <div class="dropstart relative">
                                                                ...
                                                                <ul class="dropdown-menu min-w-max absolute text-sm text-slate-700 dark:text-white hidden bg-white dark:bg-slate-700 shadow z-[2] float-left overflow-hidden list-none text-left rounded-lg mt-1 m-0 bg-clip-padding border-none">
                                                                    <!-- Edit Button -->
                                                                    <li>
                                                                        <button href="#" data-bs-toggle="modal" data-bs-target="#editModal" wire:click="loadAccountType({{ $type->id }})"
                                                                    ...
                                                                    <!-- Delete Button -->
                                                                    <li>
                                                                        <a href="#" wire:click.prevent="delete({{ $type->id }})"
                                        ...
                                        <div class="card-body rounded-md bg-white dark:bg-slate-800">
                                            <div class="items-center text-center p-5">
                                                ...
                                                <h2 class="card-title text-slate-900 dark:text-white mb-3">
                                                    No account types found!</h2>
                                                <p class="card-text">Try changing the filters or search terms for this view.
                                                </p>
                                                <a href="{{ url('/accounts') }}" class="btn inline-flex justify-center mx-2 mt-3 btn-primary active btn-sm">View
                                                    all Account Types</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            {{ $accountsTypes->links('vendor.livewire.bootstrap') }}
                        </div>
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                    ...
                    <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-slate-600 bg-black-500">
                        <h3 class="text-xl font-medium text-white dark:text-white capitalize">
                            {{ $accountTypeId ? 'Update Account Type' : 'Add New Account Type' }}
                        </h3>
                    ...
                    <div class="p-6 space-y-4">
                        <div class="from-group">
                            <div class="from-group mb-5">
                                ...
                                <input type="text" name="Type_name" class="form-control mt-2 w-full" wire:model.defer="Type_name" max=100>
                                @error('Type_name')
                            ...
                            <div class="from-group">
                                ...
                                <textarea name="Type_desc" class="form-control mt-2 w-full" wire:model.defer="Type_desc"></textarea>
                                @error('Type_desc')
                                    <span class="font-Inter text-sm text-danger-500 pt-2 inline-block">{{ $message }}</span>
                                @enderror
                            </div>
