<div>
    <div class="flex justify-between flex-wrap items-center">
        ...
        <div class="flex sm:space-x-4 space-x-2 sm:justify-end items-center md:mb-6 mb-4 rtl:space-x-reverse">
            ...
            <button wire:click="openOpeningBalanceExportModal" class="btn inline-flex justify-center btn-info dark:bg-blue-600 dark:text-white m-1">
    ...
    @if ($isOpeningBalanceExportModalOpen)
        <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto show" tabindex="-1" aria-labelledby="opening_balance_export_modal" aria-modal="true" role="dialog" style="display: block;">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                        ...
                        <div class="p-6 space-y-4">
                            <div class="form-group mb-5">
                                ...
                                <input type="number" id="openingBalanceYear" class="form-control mt-2 w-full {{ $errors->has('openingBalanceYear') ? '!border-danger-500' : '' }}" wire:model="openingBalanceYear" min="2000" max="{{ \Carbon\Carbon::now()->year + 10 }}" placeholder="Enter year (e.g., {{ \Carbon\Carbon::now()->year }})">
                                @error('openingBalanceYear')
                                    <span class="font-Inter text-sm text-danger-500 pt-2 inline-block">{{ $message }}</span>
                                @enderror
                                <p class="text-sm text-slate-500 mt-1">Export opening balances as of the beginning of this year</p>
                            </div>
                            ...
                            <div class="form-group mb-5">
                                <div class="checkbox-area">
                                    <label class="inline-flex items-center cursor-pointer">
                                        ...
                                        <span class="text-slate-500 dark:text-slate-400 text-sm leading-6">Include Zero Balances</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Modal footer -->
                        <div class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                            <button wire:click="closeOpeningBalanceExportModal" class="btn inline-flex justify-center btn-outline-dark">
                                Cancel
                            </button>
                            <button wire:click="exportOpeningBalances" class="btn inline-flex justify-center btn-info dark:bg-blue-600 dark:text-white">
                                <iconify-icon class="text-xl spin-slow ltr:mr-2 rtl:ml-2 relative top-[1px]" wire:loading wire:target="exportOpeningBalances" icon="line-md:loading-twotone-loop"></iconify-icon>
