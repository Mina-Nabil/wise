                                        ...
                                        <div class="overflow-hidden ">
                                            ...
                                            <table
                                                ...
                                                <tbody
                                                    ...
                                                    @foreach ($policy->gross_calculations as $calc)
                                                        @if ($editCalcId && $calc->id === $editCalcId)
                                                            <tr class="hover:bg-slate-200 dark:hover:bg-slate-700">
                                                                <td class="table-td">
                                                                    <input type="text"
                                                                        class="form-control text-center @error('eTitle') !border-danger-500 @else !border-success-500 @enderror"
                                                                        wire:model="eTitle">
                                                                </td>

                                                                <td class="table-td">
                                                                    <select
                                                                        class="form-control text-center @error('eType') !border-danger-500 @else !border-success-500 @enderror"
                                                                        wire:model="eType">
                                                                ...
                                                                <td class="table-td">
                                                                    <input type="number"
                                                                        class="form-control text-center @error('eValue') !border-danger-500 @else !border-success-500 @enderror"
                                                                        wire:model="eValue">
                                                                </td>
                                                                ...
                                                                <td class="table-td  p-1">
                                                                    <div class="flex">
                                                                        <button
                                                                            class="bg-slate-900 text-white action-btn m-1"
                                                                            wire:click="editCalc" type="button">
                                                                            <iconify-icon
                                                                                icon="material-symbols:save"></iconify-icon>
                                                                        </button>
                                                                    </div>
                                                            ...
                                                            <tr class="">
                                                                ...
                                                                <td class="table-td  p-1">
                                                                    <div class="flex">
                                                                        <button
                                                                            class=" bg-slate-900 text-white action-btn m-1"
                                                                            wire:click="editThisCalc({{ $calc->id }})"
                                                                            type="button">
                                                                            <iconify-icon
                                                                        ...
                                                                        <button
                                                                            class=" bg-slate-900 text-white action-btn m-1"
                                                                            wire:click="deleteThisCalc({{ $calc->id }})"
                                                                            type="button">
                                                                            <iconify-icon
                                                                                icon="heroicons:trash"></iconify-icon>
                                                                        </button>
                                                    ...
                                                    <tr class="hover:bg-slate-200 dark:hover:bg-slate-700">
                                                        <td class="table-td">
                                                            <input type="text" wire:model="newCalcTitle"
                                                                class=" @error('newCalcTitle') !border-danger-500  @enderror form-control w-full text-center">
                                                        </td>

                                                        <td class="table-td">
                                                            <select
                                                                class="form-control text-center @error('newCalcType') !border-danger-500 @else !border-success-500 @enderror"
                                                                wire:model="newCalcType">
                                                                @foreach ($calcTypes as $type)
                                                                    <option value="{{ $type }}">
                                                                        {{ $type }}</option>
                                                                @endforeach
                                                        ...
                                                        <td class="table-td">
                                                            <input type="text" wire:model="newCalcValue"
                                                                class=" @error('newCalcValue') !border-danger-500  @enderror form-control w-full text-center">
                                                        </td>

                                                        <td class="table-td  p-1">
                                                            <div class="flex">
                                                                <button wire:click="addCalc"
                                                                    class="btn btn-sm inline-flex justify-center btn-success shadow-base2">Add</button>
                                                            </div>
                                        ...
                                        <div class="overflow-hidden ">
                                            ...
                                            <table
                                                ...
                                                <tbody
                                                    ...
                                                    @foreach ($policy->comm_confs as $conf)
                                                        @if ($editConfId && $conf->id === $editConfId)
                                                            <tr class="hover:bg-slate-200 dark:hover:bg-slate-700">
                                                                <td class="table-td">
                                                                    <input type="text"
                                                                        class="form-control text-center @error('eConfTitle') !border-danger-500 @else !border-success-500 @enderror"
                                                                        wire:model="eConfTitle">
                                                                </td>

                                                                <td class="table-td">
                                                                    <select
                                                                        class="form-control text-center @error('eConfType') !border-danger-500 @else !border-success-500 @enderror"
                                                                        wire:model="eConfType">
                                                                        @foreach ($calcTypes as $type)
                                                                            <option value="{{ $type }}">
                                                                                {{ $type }}</option>
                                                                        @endforeach
                                                                ...
                                                                <td class="table-td">
                                                                    <input type="number"
                                                                        class="form-control text-center @error('eConfValue') !border-danger-500 @else !border-success-500 @enderror"
                                                                        wire:model="eConfValue">
                                                                </td>

                                                                <td class="table-td">
                                                                    <input type="number"
                                                                        class="form-control text-center @error('eConfDue') !border-danger-500 @else !border-success-500 @enderror"
                                                                        wire:model="eConfDue">
                                                                </td>

                                                                <td class="table-td">
                                                                    <input type="number"
                                                                        class="form-control text-center @error('eConfPen') !border-danger-500 @else !border-success-500 @enderror"
                                                                        wire:model="eConfPen">
                                                                </td>

                                                                <td class="table-td">
                                                                    <input type="checkbox" name="checkbox"
                                                                        checked="checked" wire:model="eMainPenalty">
                                                                </td>

                                                                <td class="table-td">
                                                                    <input type="checkbox" name="checkbox"
                                                                        checked="checked" wire:model="eSalesOut">
                                                                </td>
                                                                ...
                                                                <td class="table-td  p-1">
                                                                    <div class="flex">
                                                                        <button
                                                                            class="bg-slate-900 text-white action-btn m-1"
                                                                            wire:click="editConf" type="button">
                                                                            <iconify-icon
                                                                                icon="material-symbols:save"></iconify-icon>
                                                                        </button>
                                                                    </div>
                                                            ...
                                                            <tr class="">
                                                                ...
                                                                <td class="table-td  p-1">
                                                                    <div class="flex">
                                                                        ...
                                                                        <button
                                                                            class=" bg-slate-900 text-white action-btn m-1"
                                                                            wire:click="deleteThisConf({{ $conf->id }})"
                                                                            type="button">
                                                                            <iconify-icon
                                                                                icon="heroicons:trash"></iconify-icon>
                                                                        </button>
                                                    ...
                                                    <tr class="hover:bg-slate-200 dark:hover:bg-slate-700">
                                                        <td class="table-td">
                                                            <input type="text" wire:model="newConfTitle"
                                                                class=" @error('newConfTitle') !border-danger-500  @enderror form-control w-full text-center">
                                                        </td>

                                                        <td class="table-td">
                                                            <select
                                                                class="form-control text-center @error('newConfType') !border-danger-500 @else !border-success-500 @enderror"
                                                                wire:model="newConfType">
                                                                @foreach ($calcTypes as $type)
                                                                    <option value="{{ $type }}">
                                                                        {{ $type }}</option>
                                                                @endforeach
                                                        ...
                                                        <td class="table-td">
                                                            <input type="text" wire:model="newConfValue"
                                                                class=" @error('newConfValue') !border-danger-500  @enderror form-control w-full text-center">
                                                        </td>

                                                        <td class="table-td">
                                                            <input type="text" wire:model="newConfDue"
                                                                class=" @error('newConfDue') !border-danger-500  @enderror form-control w-full text-center">
                                                        </td>

                                                        <td class="table-td">
                                                            <input type="text" wire:model="newConfPen"
                                                                class=" @error('newConfPen') !border-danger-500  @enderror form-control w-full text-center">
                                                        </td>

                                                        <td class="table-td">
                                                            <input type="checkbox" name="checkbox" checked="checked"
                                                                wire:model="newMainPenalty">
                                                        </td>

                                                        <td class="table-td">
                                                            <input type="checkbox" name="checkbox" checked="checked"
                                                                wire:model="newSalesOut">
                                                        </td>

                                                        <td class="table-td  p-1">
                                                            <div class="flex">
                                                                <button wire:click="addConf"
                                                                    class="btn btn-sm inline-flex justify-center btn-success shadow-base2">Add</button>
                                                            </div>
                                        ...
                                        <div class="overflow-hidden ">
                                            ...
                                            <table
                                                ...
                                                <thead class="">
                                                    <tr>
                                                        ...
                                                        <th scope="col" class=" table-th ">
                                                            Value
                                                            <span
                                                                class="lowercase text-xs text-slate-500 dark:text-slate-400 mt-1">&nbsp;
                                                                * click on value to edit</span>
                                                        </th>
                                                ...
                                                <tbody
                                                    ...
                                                    @foreach ($policy->benefits as $benefit)
                                                        @if ($editBenefitId && $benefit->id === $editBenefitId)
                                                            <tr class="hover:bg-slate-200 dark:hover:bg-slate-700">
                                                                ...
                                                                <td class="table-td">
                                                                    <input list="benefit_options"
                                                                        class="form-control text-center @error('benefitValue') !border-danger-500 @else !border-success-500 @enderror"
                                                                        wire:model="benefitValue" />
                                                        ...
                                                        @else
                                                            <tr class="">
                                                                ...
                                                                <td class="table-td hover:bg-slate-200 dark:hover:bg-slate-700 cursor-pointer"
                                                                    wire:click="editThisBenefit({{ $benefit->id }})">
                                                                    {{ $benefit->value }}
                                                                </td>
                                                                ...
                                                                <td class="table-td  p-1">
                                                                    <div class="flex">
                                                                        <button
                                                                            class="toolTip onTop bg-slate-900 text-white action-btn m-1"
                                                                            data-tippy-content="Delete"
                                                                            wire:click="deleteThisBenefit({{ $benefit->id }})"
                                                                            type="button">
                                                                            <iconify-icon
                                                                                icon="heroicons:trash"></iconify-icon>
                                                                        </button>
                                                    ...
                                                    <tr class="hover:bg-slate-200 dark:hover:bg-slate-700">
                                                        <td class="table-td">
                                                            ...
                                                            <select wire:model="newBenefit"
                                                                class=" @error('newBenefit') !border-danger-500  @enderror form-control w-full text-center">
                                                        ...
                                                        <td class="table-td">
                                                            <input list="benefit_options"
                                                                class="form-control text-center @error('newValue') !border-danger-500 @enderror"
                                                                wire:model="newValue" />
                                                            <datalist id="benefit_options">
                                                                <option>مغطي</option>
                                                                <option>غير مغطي</option>
                                                ...
                                                <p class=" text-xs text-slate-500 dark:text-slate-400 mt-1">&nbsp;
                                                    <iconify-icon icon="icons8:idea"></iconify-icon> Added benefits
                                                    will not appear in add new list</p>
                                            </table>
                ...
                <div
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                        ...
                        <div
                            ...
                            <button wire:click="dismissDeleteCalculation" type="button"
                                class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center
                                            dark:hover:bg-slate-600 dark:hover:text-white"
                                data-bs-dismiss="modal">
                                <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20"
...
11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                        ...
                        <div
                            class="flex items-center p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                            <button wire:click="deleteCalc" data-bs-dismiss="modal"
                                class="btn inline-flex justify-center text-white bg-danger-500">Yes, Delete</button>
                        </div>
                    </div>
                </div>
