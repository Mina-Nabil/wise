        ...
        <div class="flex justify-between items-center space-x-7 flex-wrap mb-5">
            ...
            <div class="flex sm:space-x-4 space-x-2 sm:justify-end items-center md:mb-6 mb-4 rtl:space-x-reverse">
                @if (Auth::user()->is_admin ||
                        (($outstandingType == 'commission' || $outstandingType == 'invoice') &&
                            Auth::user()->can('viewCommission', App\Models\Business\SoldPolicy::class)))
        ...
        <div class="overflow-x-auto -mx-6">
            <div class="inline-block min-w-full align-middle">
                ...
                <div class="card">
                    ...
                    <header class="card-header cust-card-header noborder justify-start gap-2">
                                                        ...
                                                        @foreach ($soldPolicies as $policy)
                                                            <tr class="even:bg-slate-50 dark:even:bg-slate-700">
                                                                ...
                                                                @can('viewCommission',
                                                                    ...
                                                                    <td class="table-td">
                                                                        <span class="block date-text">
                                                                            {{ number_format($policy->total_comp_paid + $policy->company_comm_payments_sum_tax_amount, 2) }}</span>
                                                                    </td>
                                                                    <td class="table-td">
                                                                        <span
                                                                            class="block date-text">{{ number_format($policy->total_comp_paid - $policy->total_comp_paid + $policy->company_comm_payments_sum_tax_amount, 2) }}</span>
                                                                    </td>
                                                                        ...
                                                                        <thead class="bg-slate-200 dark:bg-slate-700">
                                                                            <tr>
                                                                                <th scope="col" class="table-th"
                                                                                    style="width: 50px">
                                                                                    <button
                                                                                        wire:click="toggleSelectAllCompanies"
