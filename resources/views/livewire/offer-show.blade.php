            ...
            <div class="grid-cols-1 gap-5 mb-5 col-span-5">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                        <h5><b><bdi>{{ $offer->client->full_name }}</bdi> - #{{ $offer->id }}</b>
                            @if ($offer->status === 'new')
                        ...
                        <div>
                            <div class="dropdown relative float-right">
                                ...
                                <ul
                                    ...
                                    @endif
                                    <li wire:click="openSetSubStatusOnlyModal" class="cursor-pointer">
                                        <p
                                            class="text-slate-600 dark:text-white block font-Inter font-normal px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600
                                                dark:hover:text-white border-t border-slate-100 dark:border-slate-800">
                                            Set Sub Status</p>
                ...
                <div
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                        ...
                        <div
                            ...
                            <button wire:click="closeSetSubStatusOnlyModal" type="button"
                                class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-slate-600 dark:hover:text-white"
                                data-bs-dismiss="modal">
                                <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="p-6 space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                                <div class="from-group">
                                    <label for="subStatusOnly" class="form-label">Sub Status</label>
                                    <input type="text" name="subStatusOnly" class="form-control mt-2 w-full"
                                        wire:model.defer="subStatusOnly" placeholder="Enter sub status...">
                                    @error('subStatusOnly')
                                        <span
                                            class="font-Inter text-sm text-danger-500 pt-2 inline-block">{{ $message }}</span>
                                    @enderror
                        ...
                        <div
                            class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                            <button wire:click="saveSetSubStatusOnly" data-bs-dismiss="modal"
                                class="btn inline-flex justify-center text-white bg-black-500">
                                Submit
                            </button>
                        </div>
