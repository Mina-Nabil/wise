            ...
            <div class="card-text h-full">
                <ul class="nav nav-tabs flex flex-col md:flex-row flex-wrap list-none border-b-0 pl-0 mb-4"
                    ...
                    <li class="nav-item" role="presentation">
                        <a wire:click.prevent="changeSection('overview')"
                            class="nav-link w-full flex items-center font-medium text-sm font-Inter leading-tight capitalize border-x-0 border-t-0 border-b border-transparent px-4 pb-2 my-2 hover:border-transparent focus:border-transparent cursor-pointer @if ($section === 'overview') active @endif dark:text-slate-300">
                            <iconify-icon class="mr-1" icon="heroicons:chart-bar"></iconify-icon>
                            Overview
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a wire:click.prevent="changeSection('customers')"
                            class="nav-link w-full flex items-center font-medium text-sm font-Inter leading-tight capitalize border-x-0 border-t-0 border-b border-transparent px-4 pb-2 my-2 hover:border-transparent focus:border-transparent cursor-pointer @if ($section === 'customers') active @endif dark:text-slate-300">
                            <iconify-icon class="mr-1" icon="heroicons:user"></iconify-icon>
                            Customers
                            <span class="ml-2 badge bg-info-500 bg-opacity-20 text-info-500 text-xs">{{ $totalCustomers }}</span>
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a wire:click.prevent="changeSection('corporates')"
                            class="nav-link w-full flex items-center font-medium text-sm font-Inter leading-tight capitalize border-x-0 border-t-0 border-b border-transparent px-4 pb-2 my-2 hover:border-transparent focus:border-transparent cursor-pointer @if ($section === 'corporates') active @endif dark:text-slate-300">
                            <iconify-icon class="mr-1" icon="heroicons:building-office-2"></iconify-icon>
                            Corporates
                            <span class="ml-2 badge bg-warning-500 bg-opacity-20 text-warning-500 text-xs">{{ $totalCorporates }}</span>
                        </a>
                    </li>
                </ul>
                ...
                @if ($section === 'overview')
                    <div class="grid lg:grid-cols-2 grid-cols-1 gap-6">
                        {{-- Campaign Details --}}
                        <div>
                            <h6 class="font-medium text-slate-700 dark:text-slate-300 mb-3 text-base">Campaign Details</h6>
                            <div class="space-y-3">
                        ...
                        <div>
                            <h6 class="font-medium text-slate-700 dark:text-slate-300 mb-3 text-base">Conversion Breakdown</h6>
                            <div class="space-y-3">
