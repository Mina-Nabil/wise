        ...
        @foreach ($contacts as $contact)
            <div class="vcard-container grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 mt-5">
                <div class="card p-5" style="text-align: -webkit-center;">
                    ...
                    @else
                        <img src="{{ asset('assets\images\avatar\user.png') }}" alt="First Name Last Name"
                            width="150px">
                    @endif

                    <div class="text-center">
                        <h6 class="mt-2 mb-2">{{ ucwords($contact->first_name) }} {{ ucwords($contact->last_name) }}
                        </h6>
                        ...
                        <p class="text-slate-900 dark:text-slate-300 mt-2"><iconify-icon
                                icon="mdi:location"></iconify-icon>
