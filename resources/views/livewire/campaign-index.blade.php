                                ...
                                <div class="card-text h-full">
                                    <div class="px-4 pt-4 pb-3">
                                        ...
                                        <div class="input-area mb-3">
                                            ...
                                            <textarea class="form-control @error('description') !border-danger-500 @enderror" wire:model.defer="description"
                                        ...
                                        <div class="input-area mb-3">
                                            ...
                                            <textarea class="form-control @error('offers') !border-danger-500 @enderror" wire:model.defer="offers"
                                                placeholder="Campaign offers"></textarea>
                                            @error('offers')
                                                <span
                                                    class="font-Inter text-sm text-danger-500 pt-2 inline-block">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="input-area mb-3">
                                            ...
                                            <textarea class="form-control @error('goal') !border-danger-500 @enderror" wire:model.defer="goal"
                                                placeholder="Campaign goal"></textarea>
                                            @error('goal')
                                                <span
                                                    class="font-Inter text-sm text-danger-500 pt-2 inline-block">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="input-area mb-3">
                                            <label for="marketing_channels" class="form-label">Marketing
                                                Channels</label>
                                            <input type="text"
                                ...
                                <div class="card-text h-full">
                                    <div class="px-4 pt-4 pb-3">
                                        ...
                                        <div class="input-area mb-3">
                                            ...
                                            <input type="text"
                                                class="form-control @error('marketing_channels') !border-danger-500 @enderror"
                                                wire:model.defer="marketing_channels"
                            ...
                            dark:hover:bg-slate-600 dark:hover:text-white"
                                ...
                                <div class="p-6 space-y-4">
                                    ...
                                    <p class="text-base text-slate-600 dark:text-slate-400 leading-6">
                                        This action cannot be undone. The campaign will be permanently deleted from the
                                        system.
                                        @if ($campaignToDelete && !$campaignToDelete->canDelete())
                                            <br><strong class="text-danger-500">Warning: This campaign has customers or
                                                corporates
                                ...
                                <div class="card-text h-full">
                                    <div class="px-4 pt-4 pb-3">
                                        <div class="mb-4 p-3 bg-info-50 dark:bg-slate-800 rounded-lg">
                                            ...
                                            <ul
                                                class="text-xs text-slate-600 dark:text-slate-400 list-disc list-inside space-y-1">
                                                <li><strong>Column A:</strong> Platform/Channel</li>
                                                <li><strong>Column B:</strong> Interest Type (تأمين_صحى,
                                                    تأمين_على_العربية,
                                                    تأمين_على_بيتك, اخر)</li>
                                        ...
                                        <div class="input-area mb-3">
                                            ...
                                            <input type="file"
                                                ...
                                                wire:model="importLeadsFile" accept=".xlsx,.xls">
                                        ...
                                        @if (auth()->user()->is_admin)
                                            <div class="input-area mb-3">
                                                <label for="importUserId" class="form-label">Assign to User
                                                    (Optional)</label>
                                                <select
                                                    class="form-control @error('importUserId') !border-danger-500 @enderror"
                                        ...
                                        <div class="mb-3 p-3 bg-warning-50 dark:bg-slate-800 rounded-lg">
                                            <p class="text-xs text-slate-600 dark:text-slate-400">
                                                <strong>Note:</strong> Rows with duplicate phone numbers and first names
                                                will be
                                    ...
                                    <div
                                        ...
                                        <button wire:click="importLeads" wire:loading.attr="disabled"
                                            ...
                                            <span wire:loading wire:target="importLeads">
                                                <iconify-icon class="text-xl animate-spin"
                        ...
                        <div class="card-text h-full">
                                    ...
                                    <div class="flex items-center gap-2 flex-shrink-0">
                                        @can('importLeads', $campaign)
                                            <button wire:click="openImportLeads({{ $campaign->id }})"
                                                ...
                                                type="button" title="Import Leads">
                                                <span wire:loading.remove wire:target="openImportLeads">
                                                    <iconify-icon icon="heroicons:arrow-up-tray"
                                                        class="text-lg"></iconify-icon>
                                                </span>
                                                <span wire:loading wire:target="openImportLeads">
                                                    <iconify-icon class="text-lg animate-spin"
                                                        icon="line-md:loading-twotone-loop"></iconify-icon>
                                                </span>
                                            </button>
                                        @endcan
                                        @can('update', $campaign)
                                            <button wire:click="openEditCampaign({{ $campaign->id }})"
                                                class="btn btn-sm btn-warning light" type="button"
                                                title="Edit Campaign">
                                        ...
                                        @can('delete', $campaign)
                                            <button wire:click="openDeleteCampaign({{ $campaign->id }})"
                                                class="btn btn-sm btn-danger light" type="button"
                            ...
                            <div class="py-4 px-5">
                                @if ($campaign->description)
                                    <p class="card-text text-sm text-slate-600 dark:text-slate-300 mb-3">
                                ...
                                <div class="space-y-2 mb-4">
                                    @if ($campaign->target_audience)
                                        <div class="flex items-start gap-2">
                                            <span
                                                class="text-slate-700 dark:text-slate-300 font-medium text-sm min-w-[80px]">Target:</span>
                                            <span
                                                class="text-slate-600 dark:text-slate-400 text-sm">{{ $campaign->target_audience }}</span>
                                        </div>
                                    @endif
                                    ...
                                    @if ($campaign->handler)
                                        <div class="flex items-start gap-2">
                                            <span
                                                class="text-slate-700 dark:text-slate-300 font-medium text-sm min-w-[80px]">Handler:</span>
                                            <span
                                                class="text-slate-600 dark:text-slate-400 text-sm">{{ $campaign->handler }}</span>
                                        </div>
                                    @endif
                                    ...
                                    @if ($campaign->budget)
                                        <div class="flex items-start gap-2">
                                            <span
                                                class="text-slate-700 dark:text-slate-300 font-medium text-sm min-w-[80px]">Budget:</span>
                                            <span
                                                class="text-slate-600 dark:text-slate-400 text-sm">${{ number_format($campaign->budget, 2) }}</span>
                                        </div>
                                    @endif
                                    ...
                                    @if ($campaign->start_date || $campaign->end_date)
                                        <div class="flex items-start gap-2">
                                            <span
                                                class="text-slate-700 dark:text-slate-300 font-medium text-sm min-w-[80px]">Period:</span>
