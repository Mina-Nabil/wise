                                                                ...
                                                                <div class="relative">
                                                                    <div class="dropstart relative">
                                                                        ...
                                                                        <ul class="dropdown-menu min-w-max absolute text-sm text-slate-700 dark:text-white hidden bg-white dark:bg-slate-700 shadow z-[2] float-left overflow-hidden list-none text-left rounded-lg mt-1 m-0 bg-clip-padding border-none">
                                                                            <li wire:click='openConfirmInvoice({{ $invoice->id }})' >
                                                                                <a href="#"
                                                                            ...
                                                                            <li wire:click="$emit('showConfirmation', 'Are you sure you want to delete this invoice?','danger','deleteInvoice' , {{ $invoice->id }})">
                                                                                <a href="#"
                                                                                    class="hover:bg-slate-900 dark:hover:bg-slate-600 dark:hover:bg-opacity-70 hover:text-white w-full border-b border-b-gray-500 border-opacity-10 px-4 py-2 text-sm dark:text-slate-300 last:mb-0 cursor-pointer first:rounded-t last:rounded-b flex space-x-2 items-center capitalize rtl:space-x-reverse">
                                    ...
                                    <div class="inline-block min-w-full align-middle">
                                        <div class="overflow-hidden ">
                                            ...
                                            <div class="text-center m-3">
                                                <small>
                                                    Showing items {{ $available_policies->firstItem() }}-{{ $available_policies->lastItem() }} of {{ $available_policies->total() }}.
                                                </small>
                                            </div>
