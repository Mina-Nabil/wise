                        ...
                        <div class="relative">
                            <div class="dropdown relative">
                                ...
                                <ul
                                    ...
                                    <li>
                                        <a href="#"
                                            class="w-full text-slate-600 dark:text-white font-Inter font-normal px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 space-x-2 rtl:space-x-reverse inline-flex items-center dark:hover:text-white">
                    ...
                    <ul class="divide-y divide-slate-100 dark:divide-slate-700 -mb-6 h-full email-list">
                        ...
                        @else
                            ...
                            <li data-status="sent,spam,personal,business" data-stared="false"
                                class="flex px-7 space-x-6 group md:py-6 py-3 relative cursor-pointer hover:bg-slate-50 dark:hover:bg-transparent group items-center rtl:space-x-reverse">
                                <div
                                    class="py-[18px] px-6 font-normal font-Inter text-sm rounded-md bg-info-500 bg-opacity-[14%] text-info-500 w-full">
